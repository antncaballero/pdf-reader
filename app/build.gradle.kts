...
android {
    namespace = "com.acaba.pdfreader"
    compileSdk = 37

    defaultConfig {
        applicationId = "com.acaba.pdfreader"
        minSdk = 29
        targetSdk = 37
        versionCode = 2
        versionName = "1.1"
    ...
    buildTypes {
        release {
            ...
            // Personal/offline distribution: use the local debug keystore so the APK can be installed with adb.
